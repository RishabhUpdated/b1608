...
vscale('c', 2)
vshift('c', np.mean(dat1_int_gaus['fluxa']) - np.mean(dat1_int_gaus['fluxc']))
# lengths_cb = halign('b', 'c')
shift_cb = -10

vscale('d', 5.9)
vshift('d', np.mean(dat1_int_gaus['fluxa']) - np.mean(dat1_int_gaus['fluxd']))
...
# plt.plot(dat1_int_gaus['day'], dat1_int_gaus['fluxa'])
# plt.plot(dat1_int_gaus['day'], dat1_int_gaus['fluxb'])
# plt.plot(dat1_int_gaus['day'], dat1_int_gaus['fluxc'])
# plt.plot(dat1_int_gaus['day'], dat1_int_gaus['fluxd'])
# plt.show()

# plt.errorbar(dat1_int_gaus['day'], dat1_int_gaus['fluxb'], yerr=dat1['errb'], fmt='bp')
# plt.plot(hshift(dat1['day'][10] - dat1['day'][0]), dat1_int_gaus['fluxa'], "co")
# plt.errorbar(dat1_int_gaus['day'], dat1_int_gaus['fluxa'], yerr=dat1['erra'], fmt='cp')
# hshift(dat1['day'][0] - dat1['day'][9])
# plt.plot(hshift(dat1['day'][10] - dat1['day'][0]), dat1_int_gaus['fluxc'], "go")
# plt.errorbar(dat1_int_gaus['day'], dat1_int_gaus['fluxc'], yerr=dat1['errc'], fmt='cp')
# hshift(dat1['day'][0] - dat1['day'][11])
# plt.plot(hshift(dat1['day'][10] - dat1['day'][0]), dat1_int_gaus['fluxd'], "yo")
# plt.errorbar(dat1_int_gaus['day'], dat1_int_gaus['fluxd'], yerr=dat1['errd'], fmt='yp')
# hshift(dat1['day'][0] - dat1['day'][21])
# plt.show()

plt.plot(hshift(dat1['day'][10] - dat1['day'][0]), dat1_int_gaus['fluxa'])
hshift(dat1['day'][0] - dat1['day'][10])
plt.plot(dat1['day'], dat1['fluxb'])
plt.plot(hshift(dat1['day'][10] - dat1['day'][0]), dat1_int_gaus['fluxc'])
hshift(dat1['day'][0] - dat1['day'][10])
plt.plot(hshift(dat1['day'][10] - dat1['day'][0]), dat1_int_gaus['fluxd'])
hshift(dat1['day'][0] - dat1['day'][10])
plt.show()
